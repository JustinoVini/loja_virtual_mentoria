...
public class AvaliacaoProdutoController {
	...
	public ResponseEntity<AvaliacaoProduto> salvarAvaliacaoProduto(
			@RequestBody @Valid AvaliacaoProduto avaliacaoProduto) throws ExceptionMentoriaJava {
	...
	public ResponseEntity<List<AvaliacaoProduto>> obterAvaliacaoProduto(@PathVariable("idProduto") Long idProduto) {
		List<AvaliacaoProduto> avaliacoesProduto = avaliacaoProdutoRepository.avaliacaoProduto(idProduto);
		return new ResponseEntity<>(avaliacoesProduto, HttpStatus.OK);
	}

	@GetMapping(value = "**/obterAvaliacaoProdutoPessoa/{idProduto}/{idPessoa}")
	public ResponseEntity<List<AvaliacaoProduto>> obterAvaliacaoProdutoPessoa(@PathVariable("idProduto") Long idProduto,
			@PathVariable("idPessoa") Long idPessoa) {
		List<AvaliacaoProduto> avaliacoesProdutoPessoa = avaliacaoProdutoRepository.avaliacaoProdutoPessoa(idProduto,
				idPessoa);
	...
	public ResponseEntity<List<AvaliacaoProduto>> obterAvaliacaoPessoa(@PathVariable("idPessoa") Long idPessoa) {
		List<AvaliacaoProduto> avaliacoesPessoa = avaliacaoProdutoRepository.avaliacaoPessoa(idPessoa);
