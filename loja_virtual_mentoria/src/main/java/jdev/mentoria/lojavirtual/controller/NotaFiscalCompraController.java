...
public class NotaFiscalCompraController {
	...
	public ResponseEntity<NotaFiscalCompra> salvarNotaFiscalCompra(
			@RequestBody @Valid NotaFiscalCompra notaFiscalCompra) throws ExceptionMentoriaJava {
		if (notaFiscalCompra.getId() == null && notaFiscalCompra.getDescricaoObs() != null) {
			...
			if (existe) {
				throw new ExceptionMentoriaJava(
						"Já existe nota fiscal de compra com a descrição: " + notaFiscalCompra.getDescricaoObs());
			}
		}
