...
public class ServiceSendEmail {
	...
	private String senha = ""; // TODO remover senha antes do commit
	...
	public void enviarEmailHtml(String assunto, String mensagem, String emailDestino) throws UnsupportedEncodingException, MessagingException {
		...
		session.setDebug(true); // mostra no console o erro que impede o envio de email
		
		Address[] toUser = InternetAddress.parse(emailDestino);

		Message message = new MimeMessage(session);
		message.setFrom(new InternetAddress(userName, "Vinicius - da Lojinha", "UTF-8")); /* Quem está enviando */
